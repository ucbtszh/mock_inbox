<template>
  <div id="welcome">
    ...
    <p>
      ...
      This study is being undertaken by researchers from Saarland University (UdS), Lahore University of Management Sciences (LUMS) and College
      London (UCL).
